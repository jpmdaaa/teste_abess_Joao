...
SECRET_KEY = 'django-insecure-kzlv-!6tgy*2qm*xj%o^s1jzexj6ikqdg(hce59vv%j68l80=='
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'jp@1234',  # Senha do banco
...
# Configurações de arquivos estáticos (se necessário)
